...
public class SunBurnConfig
{
    ...
    public static class General
    {
        ...
        General(Builder builder)
        {
            ...
            powderSnowStopsBurn = builder
                    .comment("Powder snow stops the burn. (Being in or was in powder snow stops burning)")
                    .translation("sunburn.config.powderSnowStopsBurn")
                    .define("powderSnowStopsBurn", true);
